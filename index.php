    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>E-waste Processing</h1>
          <h2>Keep our Environment Healthy</h2>
          <h3>we ensure safe handlimg of electronic waste, collect and ensure <br>
  ...
  <main id="main">
    ...
    <!--<section id="cliens" class="cliens section-bg">-->
      ...
      <div class="column">
        <div class="image1">
          <figure>
            <img src="assets/img/clients/v/1.png" alt="">
            <h4>Awareness Creation </h4><br><p>Raising Awareness on proper e- <br>
            waste management practices for <br>changing livelihoods, imprived <br>
          environment and positive <br>
        economical effect</p>
          </figure>
        </div>
        ...
        <div class="image2">
          <figure>
            <img src="assets/img/clients/v/2.png" alt="">
            <h4>E-waste Disposal</h4><br><p>Safe disposal of Unrecyclable parts</p>
          </figure>
        </div>

        <div class="image3">
          <figure>
            <img src="assets/img/clients/v/3.png" alt="">
            <h4>E-waste Processing</h4><br><p>We collect all types of electronic waste<br>
            (e-waste) for safe recycling</p>
          </figure>
        </div>

        <div class="image5">
          <figure>
            <img src="assets/img/clients/v/5.png" alt="">
            <h4>Training</h4><br><p>Awareness on e-waste handling</p>
          </figure>
        </div>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <p>
              E-waste managent offers the services of Awareness Creation(Training) <br>
              and safe disposal of electrical and electronic waste; In accodance with
              NEMA waste regulations and E-waste management that are protective to both 
              the environment and public health in Mombasa City. As a fundamental core value,
              As E-waste management runs an environmentally friendly operation. We are committed to 
              the efficent, safe and conservative disposal of electronic waste in Mombasa<thead></thead>
